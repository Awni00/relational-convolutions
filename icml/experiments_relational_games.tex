...
\begin{figure*}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/experiments/all_training_curves.pdf}
    \vskip-12pt
...
\begin{figure*}
    \centering
    \includegraphics[width=0.8\textwidth]{figs/experiments/relgames_ood_acc.pdf}
    \vskip-12pt
...
\begin{figure}
    \centering
    \includegraphics[width=0.42\textwidth]{figs/group_attn_figs/match_patt_group_attn_map.pdf}
    \vskip-10pt
