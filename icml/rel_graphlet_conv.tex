...
\todo{Does pooling for permutation invariance need to be presented differently in light of the group-attention proposal? e.g., present later, with permutations of $[s]$ rather than $g$?}
