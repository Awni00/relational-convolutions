# This module was taken from github.com/tensorflow/addons/blob/v0.20.0/tensorflow_addons/activations/sparsemax.py
# on 2023-10-14. It is licensed under the Apache License, Version 2.0.
# It implements the sparsemax activation function, described in
# [From Softmax to Sparsemax: A Sparse Model of Attention and Multi-Label Classification](https://arxiv.org/abs/1602.02068)
# The sparsemax function is simply a projection onto the simplex
