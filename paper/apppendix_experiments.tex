...
\Cref{tab:relational_games_tasks} contains text descriptions of each task in the relational games dataset in the experiments of~\Cref{ssec:exp_relational_games}. \Cref{tab:relgames_architectures} contains a description of the architectures of each model or component in the experiments. \Cref{tab:ood_generalization} reports the accuracy on the hold-out object sets (i.e., the numbers depicted in~\Cref{fig:ood_generalization} of the main text).
...
\begin{table}[ht]
    ...
    \label{tab:relgames_architectures}
\end{table}
