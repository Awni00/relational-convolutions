...
The architecture is presented in detail in Section~\ref{sec:mhr}, where a schematic of the proposed architecture is shown in~\Cref{fig:relconv_architecture}. 
