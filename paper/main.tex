...
\title{Relational Convolutional Networks: \\ A compositional architecture for learning representations of hierarchical relations}
...
% \input{appendix_efficiency.tex} % FIXME: remove
