...
We also agree about the importance of this question. In the current version of the paper, **we address this question in Appendix C**. This discussion needed to be relegated to the appendix in the initial version of the paper due to space constraints. The final submission allows an additional page, which will allow us to **add a discussion of real-world applications in the main text**. Please find a draft of the discussion to be added below.
...
[3] Rosario, et al. "The descent of hierarchy, and selection in relational semantics." Assoc for Comp Linguistics 2002

[4] Frank, et al. "How hierarchical is language use?" Proc of Royal Society 2012
